...
$reenter_newpassword = $_POST['reenter_newpassword'];
if(!empty($newpassword) && !empty($reenter_newpassword) && $reenter_newpassword== $newpassword)
{  
...
<div class="row">
                <label class="for-label">old Password</label>
                <input class="search" type="text" placeholder="enter old Password" name="oldpassword" >
                </div>
            <div class="row">
                <label class="for-label">New Password</label>
                <input class="search" type="text" placeholder="enter New Password" name="newpassword" >
                </div>
              <div class="row">
                <label class="for-label">re-enter password </label>
                <input class="search" type="text" placeholder="re-enter password" name="reenter_newpassword">
                </div>
